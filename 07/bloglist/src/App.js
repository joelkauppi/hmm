...
const App = () => {
  ...
  const userDetail = matchUserRoute
    ? userDetailsById(matchUserRoute.params.id) 
    : null

  const blogDetail = matchBlogRoute
    ? blogDetailsById(matchBlogRoute.params.id)
    : null
  ...
  return (
    <div> 
      ...
      <Switch>
        ...
        <Route path="/blogs/:id">
          <BlogDetail blog={blogDetail} addLike={handleLikeEvent}/>
        </Route>
        <Route path="/users">
          <h2>Users</h2>
          <Users users={users}/>
